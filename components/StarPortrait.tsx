...
function Hair({ star }: { star: StarProfile }) {
  ...
  if (style === "fade") {
    return <path d="M34 42c0-21 11-32 27-32 18 0 28 12 28 31-17-9-36-10-55 1Z" fill={hair} />;
  }

  if (style === "wrap") {
    return (
      <>
        <path d="M30 48c-2-22 10-38 30-38s32 16 30 39c-18-10-40-10-60-1Z" fill={hair} />
        <path d="M35 28c14 9 34 11 52 5-6-15-16-24-29-24-11 0-19 6-23 19Z" fill={star.portrait.clothing} />
